...
hi LineNr         ctermfg=250 ctermbg=0 guifg=#ffffff guibg=#000000
...
hi Error          term=reverse gui=reverse ctermfg=1 ctermbg=11 guifg=#af005f guibg=#e5e5e5
hi Todo           term=standout ctermfg=0 ctermbg=11 gui=bold guifg=#000000 guibg=#ffff00
hi String         ctermfg=112 guifg=#87d700
hi Character      ctermfg=156 guifg=#ffff87
