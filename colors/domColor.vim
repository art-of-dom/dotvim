...
hi Folded         term=standout ctermfg=229 ctermbg=0 guifg=#465457 guibg=#000000
...
hi Error          term=reverse gui=reverse ctermfg=11 ctermbg=1 guifg=#af005f guibg=#e5e5e5
hi Todo           term=standout ctermfg=0 ctermbg=11 gui=bold guifg=#000000 guibg=#ffff00
hi String         ctermfg=118 guifg=#87d700
hi Character      ctermfg=76 guifg=#ffff87
hi Number         ctermfg=56 guifg=#af00ff
...
hi Normal         ctermfg=230 ctermbg=0 guifg=#ffffd7 guibg=#121212
hi Identifier     cterm=none term=none ctermfg=246 guifg=#ffff87
hi clear Cursor
